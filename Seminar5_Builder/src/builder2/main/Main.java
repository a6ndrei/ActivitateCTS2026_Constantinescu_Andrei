...
public class Main {
    public static void main(String[] args) {
        ...
        internare1.setNumePacient("Calafiori");
        internare1.setPatRabatabil(true);

        Internare internare2 = new Internare();
        internare2.setNumePacient("Eze");
        internare2.setPatRabatabil(true);

        System.out.println(internare1);

        AbstractBuilder builder = new InternareBuilder("Olaru");
        Internare internare3 = builder.setPatRabatabil(true).build();
        Internare internare4 = builder.setPapuciCamera(true).setNumePacient("Birligea").build();
        ...
        builder2.clase.Internare internare5 = builder2.build("Paz");
        builder2.clase.Internare internare6 = builder2.build("Fabregas");
